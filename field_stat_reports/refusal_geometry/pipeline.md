# Как наполняется и строится карта: Refusal directions, harm schemas, evasion and defense of probe/latent monitors
...
Якорь сборки (as_of): 2026-06. Статей в каталоге: 153; точек на карте: 203; закрыто ≥1 статьёй: 118. Просьб будущей работы: 246. «Гигантов» по цитатам: 23 (порог Тьюки 188 цитат, абсолютный пол 100).
...
- Две горизонтальные линии — пороги «гиганта»: абсолютный пол 100 цитат (красный пунктир) и относительный порог Тьюки Q3+1.5·IQR = 188 цитат для ЭТОГО каталога (оранжевый пунктир). Выше любой из них — гигант, который обязан сохраниться при пересборке.
